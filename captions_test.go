...
var captionRequestStruct = CaptionRequest{
	Default: true,
}
...
func TestCaptions_List(t *testing.T) {
	...
	captions, err := client.Captions.List("vi2ZEQZrOQckdYZ3X5sjPse8")
	if err != nil {
		t.Errorf("Captions.List error: %v", err)
	}

	expected := &CaptionList{
		Data:       captionStructs,
...
func TestCaptions_Upload(t *testing.T) {
	...
	caption, err := client.Captions.Upload("vi2ZEQZrOQckdYZ3X5sjPse8", "en", file)
	if err != nil {
...
func TestCaptions_Update(t *testing.T) {
	...
	caption, err := client.Captions.Update("vi2ZEQZrOQckdYZ3X5sjPse8", "en", &captionRequestStruct)
	if err != nil {
		t.Errorf("Captions.Upload error: %v", err)
	}
